...
var ServicoPage = /** @class */ (function () {
    function ServicoPage(route, nav, todoService, loadingController) {
        this.route = route;
        this.nav = nav;
    ...
    ServicoPage.prototype.ngOnInit = function () {
        this.todoId = this.route.snapshot.params['id'];
        if (this.todoId) {
            this.loadTodo();
        }
    };
    ServicoPage.prototype.loadTodo = function () {
    ...
    ServicoPage.prototype.saveTodo = function () {
        return __awaiter(this, void 0, void 0, function () {
            var loading;
            var _this = this;
            return __generator(this, function (_a) {
...
export { ServicoPage };
//# sourceMappingURL=servico.page.js.map