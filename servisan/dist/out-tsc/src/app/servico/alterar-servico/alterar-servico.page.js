...
var AlterarServicoPage = /** @class */ (function () {
    function AlterarServicoPage(route, nav, todoService, loadingController) {
        this.route = route;
        this.nav = nav;
    ...
    AlterarServicoPage.prototype.loadTodo = function () {
    ...
    AlterarServicoPage.prototype.saveTodo = function () {
        return __awaiter(this, void 0, void 0, function () {
            var loading;
            var _this = this;
            return __generator(this, function (_a) {
...
export { AlterarServicoPage };
//# sourceMappingURL=alterar-servico.page.js.map